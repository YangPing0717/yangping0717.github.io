        ...
        calcTransforms() {
            ...
            */
            this.transforms = [
                ...
                {x: -1*(winsize.width/2-this.width/3), y: -1*(winsize.height/1.5-this.height/3), rotation: 0},
                {x: 0, y: 0, rotation: 0},
                {x: winsize.width/2-this.width/3, y: winsize.height/1.5-this.height/3, rotation: 0},
